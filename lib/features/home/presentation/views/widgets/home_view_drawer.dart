        ...
        builder: (context, state) {
          ...
          return ListView(
            children: [
                ...
                title: Column(
                  ...
                  children: [
                    ...
                    Text(
                      userEmail,
                      style:
                      const TextStyle(overflow: TextOverflow.ellipsis, fontSize: 18),
                    ),
                  ],
                ),
              ),
              ...
              ListTile(
                onTap: () {
                  trans.Get.to(const PatientsView(), transition: trans.Transition.downToUp);
                },
                title: const Row(
                  children: [
              ...
              ListTile(
                onTap: () {
                  trans.Get.to(const InstructionsView(), transition: trans.Transition.downToUp);
                },
                title: const Row(
                  children: [
              ...
              ListTile(
                ...
                onTap: () {
                  trans.Get.to(const AboutAppView(), transition: trans.Transition.downToUp);
                },
              ),
              const SizedBox(
                height: 15,
              ...
              ListTile(
                ...
                onTap: () {
                  trans.Get.to(const ContactUsView(), transition: trans.Transition.downToUp);
                },
              ),
              const SizedBox(
                height: 15,
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  trans.Get.offAll(
                      LoginPage()); // Use Get.to() if you want to keep the drawer
                },
              ),
            ],
          );
