...
class StrokeSexSquareWidget extends StatelessWidget {
  const StrokeSexSquareWidget({super.key, required this.img, required this.gender, required this.ontap, required this.isMale});
  final String img;
  final String gender;
